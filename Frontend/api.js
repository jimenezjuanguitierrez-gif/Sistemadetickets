...
const API = {
  ...
  async updateTicketStatus(id, estado) {
    return (await this.put(`/tickets/${id}/estado`, { estado })).data;
  },
  ...
  labLabel(l) {
    return {
      lab_a: 'Laboratorio A', lab_b: 'Laboratorio B',
      sala: 'Sala de Profesores', otros: 'Otros',
    }[l] || l;
  },
  ...
  rolLabel(r)  { return { ADMIN: 'Admin', PROFESOR: 'Profesor', USER: 'Alumno' }[r] || r; },
  rolClass(r)  { return { ADMIN: 'role-admin', PROFESOR: 'role-profesor', USER: 'role-alumno' }[r] || ''; },
  tipoLabel(t) { return { PROBLEMA: 'Problema', SOLUCION: 'Solución', IDEA: 'Idea', INFO: 'Info' }[t] || t; },
  tipoClass(t) { return { PROBLEMA: 'tag-prob', SOLUCION: 'tag-sol', IDEA: 'tag-idea', INFO: '' }[t] || ''; },
